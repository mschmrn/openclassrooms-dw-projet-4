<aside id="sidebar" class="sidebar col-2 bg-secondary py-5">
            ...
            <a class="nav-link text-white py-2" href="index.php?controller=admin&task=edit"><img src="../public/images/ecrire-article.svg" alt="">Écrire un article</a>
            <a class="nav-link text-white py-2" href="index.php?controller=admin&task=viewArticles"><img src="../public/images/gerer-article.svg" alt="">Articles</a>
            <a class="nav-link text-white py-2" href="index.php?controller=admin&task=viewDrafts"><img src="../public/images/brouillons.svg" alt="">Brouillons</a>
            ...
            <a class="nav-link text-white py-2" href="index.php?controller=admin&task=viewTrash"><img src="../public/images/corbeille.svg" alt="">Corbeille</a>
