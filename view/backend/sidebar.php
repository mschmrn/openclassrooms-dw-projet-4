...
<div class="menu my-5 px-2">
    ...
    <a class="nav-link item py-2" href="index.php?controller=admin&task=editArticle">
        <img class="<?php if ($path === "articles/edit") { ?> svg-red <?php } else { ?> invert-colors <?php } ?>" src="../public/images/create.svg" alt="Dashboard"><span class="hide <?php if ($path != "articles/edit") { ?> text-white color-hover<?php } ?>">Écrire un article</span>
    </a>
    <a class="nav-link item py-2<?php if ($path != "articles/index") { ?> text-white color-hover<?php } ?>" href="index.php?controller=admin&task=viewArticles">
        <img class="<?php if ($path === "articles/index") { ?> svg-red <?php } else { ?> invert-colors <?php } ?>" src="../public/images/articles.svg" alt="Dashboard"><span class="hide">Articles</span>
    </a>
    <a class="nav-link item py-2<?php if ($path != "articles/drafts") { ?> text-white color-hover<?php } ?>" href="index.php?controller=admin&task=viewDrafts">
        <img class="<?php if ($path === "articles/drafts") { ?> svg-red <?php } else { ?> invert-colors <?php } ?>" src="../public/images/drafts.svg" alt="Dashboard"><span class="hide">Brouillons</span>
    </a>
    <a class="nav-link item py-2<?php if ($path != "comments") { ?> text-white color-hover<?php } ?>" href="index.php?controller=admin&task=viewComments">
        <img class="<?php if ($path === "comments") { ?> svg-red <?php } else { ?> invert-colors <?php } ?>" src="../public/images/comments.svg" alt="Dashboard"><span class="hide">Commentaires</span>
    </a>
    <a class="nav-link item py-2<?php if ($path != "users") { ?> text-white color-hover<?php } ?>" href="index.php?controller=admin&task=viewUsers">
        <img class="<?php if ($path === "users") { ?> svg-red <?php } else { ?> invert-colors <?php } ?>" src="../public/images/users.svg" alt="Dashboard"><span class="hide">Utilisateurs</span>
    </a>
    <a class="nav-link item py-2<?php if ($path != "trash") { ?> text-white color-hover<?php } ?>" href="index.php?controller=admin&task=viewTrash">
        <img class="<?php if ($path === "trash") { ?> svg-red <?php } else { ?> invert-colors <?php } ?>" src="../public/images/trash.svg" alt="Dashboard"><span class="hide">Corbeille</span>
    </a>
