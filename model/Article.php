...
class Article extends Model
{
    ...
    {
        $query = $this->pdo->prepare('INSERT INTO oc_projet4_articles SET title = :title, introduction = :introduction, content = :content, draft = :draft, created_at = NOW()');
    ...
    {
        $query = $this->pdo->prepare('UPDATE oc_projet4_articles SET title = :title, introduction = :introduction, content = :content, draft = :draft, created_at = NOW() WHERE id = :id');
